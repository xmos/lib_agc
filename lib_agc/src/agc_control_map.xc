...
unsigned agc_control_map[agc_num_commands][3] = {
    ...
    {agc_cmd_set_agc_min_gain,           AGC_INPUT_CHANNELS, vtb_ctrl_fixed_16_16},
    {agc_cmd_get_agc_min_gain,           AGC_INPUT_CHANNELS, vtb_ctrl_fixed_16_16},
    {agc_cmd_set_agc_adapt,              AGC_INPUT_CHANNELS, vtb_ctrl_uint32},
    {agc_cmd_get_agc_adapt,              AGC_INPUT_CHANNELS, vtb_ctrl_uint32},
    {agc_cmd_set_agc_adapt_on_vad,       AGC_INPUT_CHANNELS, vtb_ctrl_uint32},
    {agc_cmd_get_agc_adapt_on_vad,       AGC_INPUT_CHANNELS, vtb_ctrl_uint32},
    {agc_cmd_set_agc_soft_clipping,      AGC_INPUT_CHANNELS, vtb_ctrl_uint32},
    {agc_cmd_get_agc_soft_clipping,      AGC_INPUT_CHANNELS, vtb_ctrl_uint32},
